											...
											<tr>
												...
												<div align="center">
													<table border="0" width="511" cellspacing="0" cellpadding="0" id="table6">
														<%
sql="select id,enid from indepot where inid="&clng(Request.Cookies("id"))&" order by id desc"
rs.open sql,conn,1,1
if rs.recordcount=0 then
           response.write "您暂时没有教员信息！<br>添加方法：找到需要的教员，在联系方式中点[添加到教员库]，即可收藏指定的教员信息。"
           else
	rs.pagesize=10
	page=request("page")       
	if page="" then page=1       
	...
	rs.absolutepage=page
														...
														%>
														<tr>
															<td height="30" width="38" align="center" bordercolor="#C0C0C0" style="border-left:1px solid #C0C0C0; border-top:1px solid #C0C0C0; border-bottom:1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" bgcolor="#D9D9D9">
															<p align="center">
															<font color="#0A5DF6">
														  <b>编号</b></font></td>
...
%>	
												<tr>
															<td height="30" width="38" align="center" bordercolor="#C0C0C0" style="border-left: 1px solid #C0C0C0; border-bottom: 1px solid #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px"><%=rs("id")%></td>
															...
															<a onClick="{if(confirm('此操作将删除教员的<<%=rs1("name")%>>信息，继续吗？')){return true;}return false;}" href="del_indepot.asp?id=<%=rs("id")%>&page=<%=page%>">
...
sub nextpage(x)      
	alldel.page.value=x        
	alldel.action="control.asp?file=indepot.asp"
