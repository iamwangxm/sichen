...
rs.Close
set rs=nothing
response.write "<script language=JavaScript>" & chr(13) & "alert('图片成功上传到我站图片数据库中！由于本站图片服务是付费服务，请及时联系我站管理员为你开通[询：QQ-583164404 电话-18260298314]！好消息：本站VIP会员，赠送1月免费图片显示时间，请及时联系我们为你开通！！');" &"window.location.href = '../en_uppic.asp'" &"</script>" 
