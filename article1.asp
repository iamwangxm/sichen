...
%>			
						...
						<div align="center">
							<table border="0" width="99%" cellspacing="0" cellpadding="0" id="table14" height="197">
								<tr>
									<td height="46"  width="540" background="images/bg3.gif">
...
%>
						...
						<tr>
							...
							<td width="225">
							<p align="center">&lt; <a href="article1.asp?action=f">首页</a>&nbsp;
							<a href="article1.asp?action=p">上一页</a>&nbsp;
							<a href="article1.asp?action=n">下一页</a>&nbsp;
							<a href="article1.asp?action=l">尾页</a> &gt;</td>
							<form method="POST" action="article1.asp">
							<td width="159">							
		<p>跳转到 
