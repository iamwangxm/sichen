...
<form method="POST" name="form1" action="adddata_article.asp">
						<p>　</p>
						<table border="0" cellspacing="0" cellpadding="0" height="500">
							<tr>
								...
								<b><font color="#FFFFFF">咨询文章添加</font></b></td>
							</tr>
							<tr>
			...
			<input name="title" id="title" size="51" maxlength="30" style="float: left">
			**</td>
          </tr>
          ...
          <tr bgcolor="#F7F7F7">
            ...
            <td align="left" bgcolor="#F0F0F0" style="border-right:1px solid #000000; border-left-width: 1px; border-top-width: 1px; border-bottom-width:1px">
              ...
              <iframe id="myEditor" src="Edit/editor.htm?id=content&ReadCookie=0" frameborder="0" scrolling="no" width="621" height="500"></iframe>
            </td>
          </tr>
          <tr bgcolor="#F7F7F7">
			...
			<input type="text" name="comefrom" size="51"> </td>
          </tr>
          <tr bgcolor="#F7F7F7">
            <td height="35" bgcolor="#F0F0F0" width="44" style="border-left: 1px solid #000000; border-right-width: 1px; border-top-width: 1px; border-bottom-width: 1px" align="center">
			<p align="center">类别：</td>
            <td height="35" bgcolor="#F0F0F0" width="560" style="border-right: 1px solid #000000; border-top-width: 1px; border-bottom-width: 1px">
			&nbsp;&nbsp; <input type="radio" value="1" checked name="class">家教新闻&nbsp;&nbsp; 
			<input type="radio" name="class" value="2">经验技巧</td>
          </tr>
							<tr>
